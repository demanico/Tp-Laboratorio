...
class TablaUsuarios
{
    ...
    public function mostrarTablaUsuarios()
    {
        ...
        for ($i = 0; $i < count($usuarios); $i++) {
            ...
            $acciones = "<button type='button' class='btn btn-warning btnBoton' tipo='editar' id_usuario='" . $usuarios[$i]["id_usuario"] . "' data-bs-toggle='modal' data-bs-target='#editar-usuario'><i class='fas fa-edit'></i></button> <button type='button' id_usuario='" . $usuarios[$i]["id_usuario"] . "' class='btn btn-danger btnEliminarUsuario'><i class='fas fa-trash'></i></button>";
